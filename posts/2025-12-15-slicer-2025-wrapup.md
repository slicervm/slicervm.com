...
* [Go SDK - example to convert input file via ffmpeg](https://docs.slicervm.com/platform/go-sdk/)
...
A brave and curious group of individuals from managers, to VPs, to hackers took out a subscription for Slicer to kick the tires and see what it could do. From the feedback we've seen so far, they were not disappointed.
...
If you'd like to try out Slicer, you can do so via the [Slicer website](https://slicervm.com/) with the Individual tier for personal and commercial use, or Team/Platform for your team.
